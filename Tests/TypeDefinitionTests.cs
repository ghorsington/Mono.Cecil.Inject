...
namespace Tests
{
    public class TypeDefinitionTests
    {
        ...
        public static void Main(string[] args)
        {
            ...
            typeof (Dictionary<,>).MakeGenericType(ParamHelper.CreateDummyType("T"), ParamHelper.CreateDummyType("T")));
            ...
            typeof (Dictionary<,>).MakeGenericType(ParamHelper.CreateDummyType("U"), ParamHelper.CreateDummyType("T")))));
            ...
            "HookTest1",
            testType.GetMethod("Test2"),
            InjectFlags.ModifyReturn | InjectFlags.PassLocals | InjectFlags.PassInvokingInstance | InjectFlags.PassTag
